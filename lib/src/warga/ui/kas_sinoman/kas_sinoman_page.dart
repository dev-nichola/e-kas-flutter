...
class WargaSinomanPage extends StatefulWidget {
  final String kategoriKas; // Parameter yang diperlukan

  const WargaSinomanPage({super.key, required this.kategoriKas});

  @override
  _WargaSinomanPageState createState() => _WargaSinomanPageState();
}

class _WargaSinomanPageState extends State<WargaSinomanPage> {
