...
class WargaUpdateDiriPage extends StatefulWidget {
  final String diriId;
  final Map<String, dynamic>? initialData;

  const WargaUpdateDiriPage({
    super.key,
  ...
  _WargaUpdateDiriPageState createState() => _WargaUpdateDiriPageState();
}

class _WargaUpdateDiriPageState extends State<WargaUpdateDiriPage> {
  int _currentIndex = 5;
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => const WargaDataDiriPage()),
                );
              },
            ),
          ],
