...
class WargaAgustusanPage extends StatefulWidget {
  final String kategoriKas; // Parameter yang diperlukan

  const WargaAgustusanPage({super.key, required this.kategoriKas});

  @override
  _WargaAgustusanPageState createState() => _WargaAgustusanPageState();
}

class _WargaAgustusanPageState extends State<WargaAgustusanPage> {
