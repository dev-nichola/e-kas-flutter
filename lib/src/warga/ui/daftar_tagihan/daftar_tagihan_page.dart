...
import '../../../../service/warga/tagihan/tagihanlist_service.dart';
import '../../../../service/warga/tagihan/models/tagihan_model.dart';
import 'payment_method_page.dart'; // Import the payment method page

class WargaTagihanPage extends StatefulWidget {
  const WargaTagihanPage({super.key});

  @override
  _WargaTagihanPageState createState() => _WargaTagihanPageState();
}

class _WargaTagihanPageState extends State<WargaTagihanPage> {
  int _currentIndex = 4;
