...
import 'package:e_kas/src/shared/rt/navbar_widget.dart';
import 'package:e_kas/src/shared/rt/topbar_widget.dart';
import '../../../../service/rt/laporankas_service.dart';
...
class AgustusanPage extends StatefulWidget {
  final String kategoriKas; // Parameter yang diperlukan

  const AgustusanPage({super.key, required this.kategoriKas});

  @override
  _AgustusanPageState createState() => _AgustusanPageState();
}

class _AgustusanPageState extends State<AgustusanPage> {
