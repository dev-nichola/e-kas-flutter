...
class BulananPage extends StatefulWidget {
  final String kategoriKas; // Parameter yang diperlukan

  const BulananPage({super.key, required this.kategoriKas});

  @override
  _BulananPageState createState() => _BulananPageState();
}

class _BulananPageState extends State<BulananPage> {
