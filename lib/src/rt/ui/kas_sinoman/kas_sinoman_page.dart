...
class SinomanPage extends StatefulWidget {
  final String kategoriKas; // Parameter yang diperlukan

  const SinomanPage({super.key, required this.kategoriKas});

  @override
  _SinomanPageState createState() => _SinomanPageState();
}

class _SinomanPageState extends State<SinomanPage> {
