...
import 'package:e_kas/src/bendahara/ui/data_diri/riwayat_page.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:e_kas/service/bendahara/datadiri_service.dart';
import 'package:e_kas/src/bendahara/ui/data_diri/updatediripage.dart';
import '../../../shared/bendahara/navbar_widget.dart';
import '../../../shared/bendahara/topbar_widget.dart';

class BendaharaDataDiriPage extends StatefulWidget {
  const BendaharaDataDiriPage({super.key});

  @override
  _BendaharaDataDiriPageState createState() => _BendaharaDataDiriPageState();
}

class _BendaharaDataDiriPageState extends State<BendaharaDataDiriPage> {
  int _currentIndex = 5;
  ...
  void _navigateToUpdatePage() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BendaharaUpdateDiriPage(
          diriId: _userData?['id'] ?? '', 
  ...
  void _navigateToRiwayatPage() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BendaharaRiwayatPage(
