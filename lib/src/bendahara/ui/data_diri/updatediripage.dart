...
class BendaharaUpdateDiriPage extends StatefulWidget {
  final String diriId;
  final Map<String, dynamic>? initialData;

  const BendaharaUpdateDiriPage({
    super.key,
  ...
  _BendaharaUpdateDiriPageState createState() => _BendaharaUpdateDiriPageState();
}

class _BendaharaUpdateDiriPageState extends State<BendaharaUpdateDiriPage> {
  int _currentIndex = 5;
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => const BendaharaDataDiriPage()),
                );
              },
            ),
          ],
