import 'dart:async';
import 'dart:convert';
import 'package:e_kas/service/bendahara/tagihan/models/payment_method_model.dart';
...
import '../../../../service/bendahara/tagihan/cekstatus_service.dart';
import '../../../../service/bendahara/tagihan/payment_method_service.dart';
        ...
        Future.delayed(const Duration(seconds: 1), () {
          if (mounted) {
            ...
            Navigator.of(context).pushReplacement(
              MaterialPageRoute(
                builder: (context) => const BendaharaTagihanPage(),
              ),
            );
          }
        });
