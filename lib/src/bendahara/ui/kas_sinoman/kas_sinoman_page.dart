...
class BendaharaSinomanPage extends StatefulWidget {
  final String kategoriKas; // Parameter yang diperlukan

  const BendaharaSinomanPage({super.key, required this.kategoriKas});

  @override
  _BendaharaSinomanPageState createState() => _BendaharaSinomanPageState();
}

class _BendaharaSinomanPageState extends State<BendaharaSinomanPage> {
