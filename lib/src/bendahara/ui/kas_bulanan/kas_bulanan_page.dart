...
class BendaharaBulananPage extends StatefulWidget {
  final String kategoriKas; // Parameter yang diperlukan

  const BendaharaBulananPage({super.key, required this.kategoriKas});

  @override
  _BendaharaBulananPageState createState() => _BendaharaBulananPageState();
}

class _BendaharaBulananPageState extends State<BendaharaBulananPage> {
