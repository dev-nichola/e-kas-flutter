...
import 'package:e_kas/src/shared/bendahara/navbar_widget.dart';
import 'package:e_kas/src/shared/bendahara/topbar_widget.dart';
import '../../../../service/bendahara/laporankas_service.dart';
...
class BendaharaAgustusanPage extends StatefulWidget {
  final String kategoriKas; // Parameter yang diperlukan

  const BendaharaAgustusanPage({super.key, required this.kategoriKas});

  @override
  _BendaharaAgustusanPageState createState() => _BendaharaAgustusanPageState();
}

class _BendaharaAgustusanPageState extends State<BendaharaAgustusanPage> {
